...
(function () {
  ...
  I18N["zh"] = {
    ...
    settings_sync_framework_label: "同步语言到框架",
    settings_sync_framework_desc: "将仪表盘当前界面语言写入框架配置，框架与模块输出的消息将使用该语言",
    settings_sync_on_applied: "已套用全局外观",
    settings_sync_off_restored: "已关闭同步，恢复本地外观",
    settings_upload_confirm: "将覆盖当前的全局外观，所有开启同步的设备都会被更新。确定继续？",
...
settings_tab_colorfont: "颜色与字体",
    ...
    settings_sync: "同步",
    settings_global_scope_desc: "开启后本设备自动套用已上传的全局外观；关闭后恢复开启前的本地外观",
    settings_upload_global_desc: "将当前设备的外观上传为全局外观，所有开启同步的设备会自动套用",
    ...
    update_hint_framework: "ErisPulse 框架已更新到 v{v}，建议重启框架以应用新特性并清理缓存。",
    update_hint_dashboard: "Dashboard 已更新，模块已自动重载使新版生效；如遇异常，建议重启框架。",
    update_hint_restart: "立即重启",
    expand_all: "展开全部",
    collapse_all: "收起全部",
    ...
    /* ── 安装配置引导 / 新手清单（UX） ── */
    install_guide_title: "安装成功",
    install_guide_single: "「{name}」安装成功，是否立即进行配置？",
    install_guide_multi: "以下新组件安装成功，是否立即进行配置？",
    install_guide_config_btn: "配置 {name}",
    install_guide_later: "稍后再说",
    adapter_installed_toast: "适配器「{name}」安装成功",
    goto_config: "去配置",
    accounts_empty_title: "尚未添加账户",
    accounts_empty_desc: "适配器需要至少一个账户（Bot）才能连接平台收发消息。保存后会自动重载，可随时修改。",
    add_first_account: "添加第一个账户",
    view_docs: "查看文档",
    /* ── 全局搜索 ── */
    palette_placeholder: "搜索页面、组件、操作…",
    palette_empty: "没有匹配的结果",
    palette_group_pages: "页面",
    palette_group_components: "组件",
    palette_group_actions: "操作",
    palette_group_recent: "最近使用",
    palette_footer: "↑↓ 选择 · Enter 打开 · Esc 关闭",
    palette_open: "全局搜索",
    sidebar_search: "搜索",
    palette_act_theme: "切换主题",
    palette_act_lang: "切换语言",
    palette_act_restart: "重启框架",
    palette_act_sidebar: "折叠 / 展开侧边栏",
    palette_act_privacy: "切换隐私模式",
    /* ── 交互兜底 ── */
    unsaved_confirm_title: "有未保存的修改",
    unsaved_confirm_text: "离开当前页面将丢失未保存的修改，确定要离开吗？",
    /* ── 引导文案补充 ── */
    install_guide_later_hint: "可随时在「组件配置」中继续配置",




    onboarding_title: "快速开始",
    onboarding_subtitle: "完成初始设置以连接机器人",
    onboarding_step1: "安装适配器",
    onboarding_step2: "添加账户并完成配置",
    onboarding_step3: "机器人连接成功",
    onboarding_progress: "剩余 {n} 步",
    onboarding_congrats: "初始化完成，机器人已上线",
