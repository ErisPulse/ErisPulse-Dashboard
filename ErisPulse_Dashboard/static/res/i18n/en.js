...
(function () {
  ...
  I18N["en"] = {
    ...
    module_disabled: "Disabled (unloaded)",
    module_disabled_running: "Disabled (unloaded)",
    reload: "Reload",
    ...
    settings_sync_framework_lang: "Sync",
    settings_sync_framework_label: "Sync language to framework",
    settings_sync_framework_desc: "Writes the dashboard's current UI language to the framework config; framework and module messages will use it",
    settings_sync_on_applied: "Global appearance applied",
    settings_sync_off_restored: "Sync off — local appearance restored",
    settings_upload_confirm: "This overwrites the current global appearance and updates every device with sync enabled. Continue?",
...
settings_tab_colorfont: "Colors & Font",
    ...
    kb_focus_search: "Open global search",
    ...
    settings_sync: "Sync",
    settings_global_scope_desc: "When on, this device automatically applies the uploaded global appearance; when off, it restores your local appearance from before",
    settings_upload_global_desc: "Upload this device's appearance as the global appearance; all devices with sync enabled will apply it",
    ...
    fw_update_done: "Framework update completed",
    update_hint_framework: "ErisPulse has been updated to v{v}. Restart the framework to apply new features and clear caches.",
    update_hint_dashboard: "Dashboard has been updated and its module reloaded automatically. If anything misbehaves, restart the framework.",
    update_hint_restart: "Restart Now",
    ...
    /* ── Install config guide / onboarding (UX) ── */
    install_guide_title: "Installed",
    install_guide_single: "{name} was installed successfully. Configure it now?",
    install_guide_multi: "The following components were installed and support configuration. Configure now?",
    install_guide_config_btn: "Configure {name}",
    install_guide_later: "Later",
    adapter_installed_toast: "Adapter {name} installed",
    goto_config: "Configure",
    accounts_empty_title: "No account yet",
    accounts_empty_desc: "An adapter needs at least one account (bot) to connect to the platform. It reloads automatically after saving and can be edited anytime.",
    add_first_account: "Add first account",
    view_docs: "Documentation",
    /* ── Global search ── */
    palette_placeholder: "Search pages, components, actions…",
    palette_empty: "No matching results",
    palette_group_pages: "Pages",
    palette_group_components: "Components",
    palette_group_actions: "Actions",
    palette_group_recent: "Recent",
    palette_footer: "↑↓ navigate · Enter open · Esc close",
    palette_open: "Global search",
    sidebar_search: "Search",
    palette_act_theme: "Toggle theme",
    palette_act_lang: "Switch language",
    palette_act_restart: "Restart framework",
    palette_act_sidebar: "Collapse / expand sidebar",
    palette_act_privacy: "Toggle privacy mode",
    /* ── Interaction guards ── */
    unsaved_confirm_title: "Unsaved changes",
    unsaved_confirm_text: "Leaving this page will discard unsaved changes. Leave anyway?",
    /* ── Guide copy extras ── */
    install_guide_later_hint: "You can configure them anytime under Component Config",




    onboarding_title: "Quick Start",
    onboarding_subtitle: "Finish the initial setup to connect a bot",
    onboarding_step1: "Install an adapter",
    onboarding_step2: "Add an account & finish setup",
    onboarding_step3: "Bot connected successfully",
    onboarding_progress: "{n} step(s) remaining",
    onboarding_congrats: "Setup complete. Bot is online.",
