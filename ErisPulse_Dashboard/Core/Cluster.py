...
API_TO_CAPABILITY_MAP = {
    ...
    "/api/master": "master",
    "/api/scope": "master",
    "/api/scope/settings": "master",
    "/api/scope/module": "master",
    "/api/scope/identity": "master",
    "/api/scope/action": "master",
    "/api/scope/test": "master",
    "/api/scope/stats/reset": "master",
    "/api/scope/runtime/cleanup": "master",
    "/api/scope/export": "master",
    "/api/scope/import": "master",
    "/api/topology": "topology",
    "/api/views": "module_views",
    "/api/cluster/nodes": "cluster_nodes",
    "/api/cluster/overview": "cluster_overview",
    # 写操作端点（权限校验用；能力 ID 与对应读端点/功能一致）
    "/api/modules/action": "modules",
    "/api/packages/install": "packages",
    "/api/packages/uninstall": "packages",
    "/api/store/install": "store_install_status",
    "/api/store/upload": "store",
    "/api/framework/update": "framework_versions",
    "/api/appearance": "appearance",
    "/api/appearance/upload": "appearance",
    "/api/fonts/upload": "appearance",
    "/api/fonts/delete": "appearance",
    "/api/i18n/language": "appearance",
    "/api/files/write": "files",
    "/api/files/delete": "files",
    "/api/files/upload": "files",
    "/api/events/clear": "events",
    "/api/logs/clear": "logs",
    "/api/lifecycle/clear": "lifecycle",
    "/api/commands/settings": "commands",
    "/api/restart": "restart",
    "/api/backup/import": "backup",
    "/api/users/tokens": "user_admin",
    "/api/users/tokens/delete": "user_admin",
}
