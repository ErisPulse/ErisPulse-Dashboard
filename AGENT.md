...
### SVG 图标
主人系统统一使用用户徽章（人像+星标）图标：
```svg
<path d="M12 3a5 5 0 1 0 0 10 5 5 0 0 0 0-10zM20 21a8 8 0 0 0-16 0M19.5 2.5l.8 1.6 1.8.26-1.3 1.27.3 1.8-1.6-.85-1.6.85.3-1.8-1.3-1.27 1.8-.26z" />
```
